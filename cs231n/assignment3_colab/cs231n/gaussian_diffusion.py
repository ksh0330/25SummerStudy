...
class GaussianDiffusion(nn.Module):
    ...
    def predict_start_from_noise(self, x_t, t, noise):
        ...
        ####################################################################
        # Extract coefficients for time t
        ...
        # Compute x_start according to Eq. (4): x_0 = (x_t - sqrt(1-α̅_t) * ε) / sqrt(α̅_t)
    ...
    def predict_noise_from_start(self, x_t, t, x_start):
        ...
        # Compute noise according to Eq. (4): ε = (x_t - sqrt(α̅_t) * x_0) / sqrt(1-α̅_t)
    ...
    def q_sample(self, x_start, t, noise):
        ...
        # Sample x_t according to Eq. (4): x_t = sqrt(α̅_t) * x_0 + sqrt(1-α̅_t) * ε
    ...
    def p_losses(self, x_start, model_kwargs={}):
        ...
        loss = loss_weight * F.mse_loss(model_output, target, reduction='none')
        loss = loss.mean()
